 ...
 *
 * Debug discovery transport for {@code VhalProbe}. Production telemetry goes exclusively
 * through EVHardware; this class deliberately owns no vehicle property ids.
 */
